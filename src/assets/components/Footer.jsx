...
function Footer() {
    ...
    <footer className="bg-slate-900 shadow-md">
        <div className="container mx-auto px-4">
            <div className="min-h-16">
                <div className="flex justify-between items-center flex-col md:flex-row py-10">
                    <h2 className="text-4xl font-bold text-white">Subscibe the newsletter</h2>
            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    <div >
                        ...
                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Obcaecati recusandae, modi voluptatibus soluta
                        </p>
                    ...
                    <div>
                        ...
                        <p>Sunder bLock Shakrpur New Delhi India</p>
                        <p>+91 9013655511</p>
                        <p>krrish9tayal@gmail.com</p>
        ...
        <div className="conatiner mx-auto text-center py-4 text-white"> 
            <p>CopyRight &copy; 2025 Krrish Tayal</p>
        </div>
